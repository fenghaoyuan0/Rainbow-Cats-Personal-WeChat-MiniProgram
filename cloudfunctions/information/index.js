...
exports.main = async (event, context) => {
  try {
    ...
    console.log(openid);
    if (openid === 'oioqs6zu2lAsRwtsVTmURpvkrFRo') {//_openidA放到单引号里
        openid = 'oioqs6_BYR4v9WbAwPOSXtDr4E1I';//_openidB放到单引号
    } else {
        openid = 'oioqs6zu2lAsRwtsVTmURpvkrFRo';//_openidA放到单引号里
    }
